...
public class HertsCoreClientCStreamingMethodHandler extends io.grpc.stub.AbstractBlockingStub<HertsCoreClientCStreamingMethodHandler> implements InvocationHandler {
    private static final Logger logger = HertsLogger.getLogger(HertsCoreClientCStreamingMethodHandler.class.getSimpleName());
    ...
    public HertsCoreClientCStreamingMethodHandler(Channel channel, CallOptions callOptions, HertsService hertsService) {
    ...
    @Override
    protected HertsCoreClientCStreamingMethodHandler build(Channel channel, CallOptions callOptions) {
