...
public class HertsCoreClientBStreamingMethodHandler extends io.grpc.stub.AbstractBlockingStub<HertsCoreClientBStreamingMethodHandler> implements InvocationHandler, HertsService {
    private static final Logger logger = HertsLogger.getLogger(HertsCoreClientBStreamingMethodHandler.class.getSimpleName());
