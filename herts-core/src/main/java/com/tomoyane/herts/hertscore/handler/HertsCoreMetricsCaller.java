...
public class HertsCoreMetricsCaller implements HertsCoreCaller {
    ...
    public HertsCoreMetricsCaller(Method reflectMethod, HertsMetrics hertsMetrics, HertsSerializer hertsSerializer,
