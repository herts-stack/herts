...
public class HertsClientSStreamingMethodHandler extends io.grpc.stub.AbstractBlockingStub<HertsClientSStreamingMethodHandler> implements InvocationHandler {
    private static final Logger logger = HertsLogger.getLogger(HertsClientSStreamingMethodHandler.class.getSimpleName());
    ...
    public HertsClientSStreamingMethodHandler(Channel channel, CallOptions callOptions, HertsService hertsService) {
...
//        this.objectMapper.disable(SerializationFeature.FAIL_ON_EMPTY_BEANS);
    ...
    @Override
    protected HertsClientSStreamingMethodHandler build(Channel channel, CallOptions callOptions) {
