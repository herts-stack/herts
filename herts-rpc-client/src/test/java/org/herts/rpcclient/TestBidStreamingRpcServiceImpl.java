...
public class TestBidStreamingRpcServiceImpl extends HertsServiceBidirectionalStreaming<TestBidStreamingRpcService> implements TestBidStreamingRpcService {
    @Override
